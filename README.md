...
[![Build Status](https://ci.jenkins.io/buildStatus/icon?job=Plugins%2Foic-auth-plugin%2Fmaster)](https://ci.jenkins.io/job/Plugins/job/oic-auth-plugin/job/master/)

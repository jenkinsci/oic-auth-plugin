...
public class OicQueryParameterConfigurationTest {
    ...
    public void testQueryParameterDecoded() {
        ...
        assertEquals("key-1", configClean.getQueryParamNameDecoded());
        assertEquals("value-1", configClean.getQueryParamValue());
        assertEquals("value-1", configClean.getQueryParamValueDecoded());
        ...
        assertEquals("key-2", configEmptyValue.getQueryParamNameDecoded());
        ...
        assertNull(configEmptyValue.getQueryParamNameDecoded());
        ...
        assertEquals("key-a%22b%2Fc%3Fd%23e%3Af%40g%26h%3Di%2Bj%24%2Bk%2Cl", config.getQueryParamNameDecoded());
        assertEquals("value-a\"b/c?d#e:f@g&h=i+j$+k,l", config.getQueryParamValue());
        assertEquals("value-a%22b%2Fc%3Fd%23e%3Af%40g%26h%3Di%2Bj%24%2Bk%2Cl", config.getQueryParamValueDecoded());
    }
